...
//
// Fuente principal: el launcher (spritenote-launch.sh / spritenote-launch.ps1) recolecta datos reales del
...
const SysInfo = (() => {
  ...
  const data = N ? {
    // ── Lanzado con spritenote-launch.sh / spritenote-launch.ps1: datos reales del sistema ──
    user:       N.user || null,
